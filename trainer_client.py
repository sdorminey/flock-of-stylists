...
parser.add_argument("--args", default='-backend cudnn -batch_size 1 -model starling -learning_rate 1e-2 -style_weight 10', help="Arguments to use for training.")
parser.add_argument("--iters", type=int, default=25, help="Iterations per cycle.")
parser.add_argument("--cycles", type=int, default=25, help="Number of cycles to train for.")
